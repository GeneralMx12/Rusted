...
Type=simple
LimitNOFILE=1000000
ExecStart=/opt/gohttp/gohttpserver -r ./public --port 8000 --auth-type http --auth-http admin:${admintoken} --cert /path/to/your/cert.pem --key /path/to/your/key.pem
...
EOF
    ...
    echo -e "You can access your install scripts for clients by going to https://${wanip}:8000"
